 ...
 */
Ext.define('Tutorial.view.binding.ChildSessionController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.binding.childsession',

    requires: [
        'Ext.window.Window',
        'Tutorial.view.binding.ChildSessionForm'
    ],
    ...
    onSaveClick: function () {
        ...
        if (form.isValid()) {
            ...
            if (!isEdit) {
                ...
                this.getStore('companies').insert(0, this.getSession().getRecord('Tutorial.model.Company', id));
            }
            this.onCancelClick();
        }
    },
